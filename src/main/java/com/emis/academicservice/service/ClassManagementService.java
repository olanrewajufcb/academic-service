...
public interface ClassManagementService {
    ...
    Flux<SchoolClassResponse> getSchoolClassBySchoolId(String schoolCode, String academicYear, Pageable pageable, String requestId);

    Flux<StudentInClassResponse> getStudentInClassByClassId(Long classId,Pageable pageable, String requestId);
}
